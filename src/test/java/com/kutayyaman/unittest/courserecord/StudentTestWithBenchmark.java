...
public class StudentTestWithBenchmark {
    ...
    class ArgumentsSourceDemo {
        ...
        @ParameterizedTest
        @ArgumentsSource(StudentTestWithParameterizedMethods.CourseCodeAndTypeProvider.class)
        void addCourseToStudent(String courseCode, Course.CourseType courseType) {
    ...
    class TypeConversionAndCustomDisplayNameDemo {
        ...
        @ParameterizedTest
        @ValueSource(strings = {"101", "103", "105"})
        void addCourseStudentWithConverter(@ConvertWith(StudentTestWithParameterizedMethods.CourseConverter.class) Course course) { //yukardaki 101 103 ve 105 i alip asagdaki CourseConverter ile Course olusturup buraya parametre olarak vercek
            final LecturerCourseRecord lecturerCourseRecord = new LecturerCourseRecord(course, new Semester());
            student.addCourse(lecturerCourseRecord);
            assertFalse(student.getStudentCourseRecords().isEmpty());
            assertTrue(student.isTakeCourse(course));
