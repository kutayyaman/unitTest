...
public class BenchmarkExtension implements BeforeAllCallback, AfterAllCallback, BeforeTestExecutionCallback, AfterTestExecutionCallback {
    ...
    @Override
    public void beforeAll(ExtensionContext context) throws Exception { //bu beforeAll ve asagidaki afterAll class bazinda caliscak
    ...
    @Override
    public void beforeTestExecution(ExtensionContext context) throws Exception { //before ve alttaki after ise method bazinda caliscak
